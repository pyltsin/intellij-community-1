...
public class RedundantCompareToJavaTimeInspection extends AbstractBaseJavaLocalInspectionTool implements CleanupLocalInspectionTool {
  private static final CallMatcher COMPARE_TO_METHODS = CallMatcher.anyOf(
    CallMatcher.instanceCall(CommonClassNames.JAVA_TIME_LOCAL_DATE, "compareTo").parameterTypes("java.time.chrono.ChronoLocalDate"),
    CallMatcher.instanceCall(CommonClassNames.JAVA_TIME_LOCAL_TIME, "compareTo").parameterTypes(CommonClassNames.JAVA_TIME_LOCAL_TIME),
    CallMatcher.instanceCall(CommonClassNames.JAVA_TIME_LOCAL_DATE_TIME, "compareTo")
      .parameterTypes("java.time.chrono.ChronoLocalDateTime"),
    CallMatcher.instanceCall(CommonClassNames.JAVA_TIME_OFFSET_TIME, "compareTo").parameterTypes(CommonClassNames.JAVA_TIME_OFFSET_TIME),
    CallMatcher.instanceCall(CommonClassNames.JAVA_TIME_OFFSET_DATE_TIME, "compareTo")
      .parameterTypes(CommonClassNames.JAVA_TIME_OFFSET_DATE_TIME)
  );

  @Override
  public @NotNull String getID() {
    return "RedundantCompareToJavaTimeStatement";
  }
  ...
  public PsiElementVisitor buildVisitor(@NotNull ProblemsHolder holder, boolean isOnTheFly) {
    return new JavaElementVisitor() {
      ...
      public void visitMethodCallExpression(@NotNull PsiMethodCallExpression call) {
        ...
        holder.registerProblem(call, InspectionGadgetsBundle.message("redundant.call.problem.descriptor"),
                               ProblemHighlightType.GENERIC_ERROR_OR_WARNING,
                               new TextRange(qualifierExpression.getStartOffsetInParent() + qualifierExpression.getTextLength(),
                                             call.getArgumentList().getStartOffsetInParent()),
  ...
  private static class InlineCompareToTimeCallFix implements LocalQuickFix {
    ...
    public String getFamilyName() {
      ...
      return InspectionGadgetsBundle.message("inspection.simplifiable.compare.java.time.fix.name", method);
    }
    ...
    private String getMethodName() {
      ...
      switch (myRelationType) {
        case EQ:
        case NE:
          if (myArgumentType.equals(CommonClassNames.JAVA_TIME_LOCAL_TIME)) {
            method = "equals";
          }
          else {
            method = "isEqual";
